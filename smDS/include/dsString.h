...
//-- IO --
cStream& FASTCALL operator << ( cStream& st, const ds_string& a );
cStream& FASTCALL operator >> ( cStream& st, ds_string& a );
//***********************************************************************
//******    wstring_tag
//***********************************************************************
//class wstring_tag
...
inline int FASTCALL StringCompare( const ds_string& str1, const ds_string& str2 )
{
